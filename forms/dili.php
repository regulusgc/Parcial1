...
<head>
  ...
  <link rel="stylesheet" href="../Diligencias/dis_diligencias.css">
...
<div class="container">
  ...
  <form class="well form-horizontal" action=" " method="post"  id="contact_form">
    <fieldset>
      ...
      <!-- Form Name -->
      <legend>Diligencias!</legend>

      <!-- Text input-->

      <div class="form-group">
        <label class="col-md-4 control-label">ID Diligencias</label>
      ...
      <div class="form-group">
        <label class="col-md-4 control-label">Unidad de Trabajo</label>
        <div class="col-md-4 selectContainer">
          <div class="input-group">
            <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
            <select name="state" class="form-control selectpicker" >
              <option value=" " >Please select your unidad XD</option>
              <option>Alto</option>
              <option>Medio</option>
              <option >Bajo</option>
      ...
      <!-- Text input-->
      <div class="form-group">
        <label class="col-md-4 control-label">Descripcion del la Diligencias</label>
        <div class="col-md-4 inputGroupContainer">
          <div class="input-group">
